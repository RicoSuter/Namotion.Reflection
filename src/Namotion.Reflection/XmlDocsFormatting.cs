...
namespace Namotion.Reflection
{
    ...
    internal static class XmlDocsFormatting
    {
        ...
        {
            var paragraph = element.ToXmlDocsContent(XmlDocsFormattingMode.Html).Trim();
        ...
        private static StringBuilder AppendMarkdownParagraph(StringBuilder stringBuilder, XElement element)
        {
            ...
            stringBuilder.Append(element.ToXmlDocsContent(XmlDocsFormattingMode.Markdown).Trim());
            return stringBuilder;
        }
